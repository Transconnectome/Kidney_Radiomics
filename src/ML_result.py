...
if __name__ == '__main__':
    ...
    best_params = {"n_estimators": 98, "max_depth": 16, "max_samples": 1.0}
    ...
    # save the ROC-AUC curve from the best result
    ...
    plt.legend()
    plt.savefig(os.path.join(args.save_Dir,'auc_roc_best_result.png'), dpi=300)
    """